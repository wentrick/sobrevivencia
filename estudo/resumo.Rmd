...
Para estimar a função de sobrevivência do estudo, é necessário realizar análises estatísticas e representar graficamente os resultados.
...
##### c) Avaliação de Fatores de Risco

Será realizada uma avaliação para determinar se o grupo é um fator de risco no estudo de malária.
